...
typedef struct _CommandIOSetState {
    IOPin pin;
    IOState state;
} CommandIOSetState;

typedef struct _CommandIOGetState {
    IOPin pin;
} CommandIOGetState;
...
typedef struct _Command {
    ...
    union {
        ...
        CommandIOGetState io_get_state;
        CommandIOSetState io_set_state;
    } cmd;
} Command;

typedef struct _ResponseIOGetState {
    IOState state;
} ResponseIOGetState;
...
typedef struct _Response {
    ...
    union {
        ...
        ResponseIOGetState io_get_state;
    } type;
} Response;
...
#define _IOPin_MIN IOPin_PIN0
#define _IOPin_MAX IOPin_PIN9
#define _IOPin_ARRAYSIZE ((IOPin)(IOPin_PIN9+1))
...
#define _IOState_MIN IOState_LOW
#define _IOState_MAX IOState_HIGH
#define _IOState_ARRAYSIZE ((IOState)(IOState_HIGH+1))
...
#define CommandIOSetState_pin_ENUMTYPE IOPin
#define CommandIOSetState_state_ENUMTYPE IOState

#define CommandIOGetState_pin_ENUMTYPE IOPin

#define ResponseIOGetState_state_ENUMTYPE IOState
...
#define CommandIOSetState_init_default           {_IOPin_MIN, _IOState_MIN}
#define CommandIOGetState_init_default           {_IOPin_MIN}
#define ResponseIOGetState_init_default          {_IOState_MIN}
...
#define CommandIOSetState_init_zero              {_IOPin_MIN, _IOState_MIN}
#define CommandIOGetState_init_zero              {_IOPin_MIN}
#define ResponseIOGetState_init_zero             {_IOState_MIN}
...
#define CommandIOSetState_pin_tag                1
#define CommandIOSetState_state_tag              2
#define CommandIOGetState_pin_tag                1
...
#define Command_io_get_state_tag                 8
#define Command_io_set_state_tag                 9
#define ResponseIOGetState_state_tag             1
...
#define Response_io_get_state_tag                7
...
X(a, STATIC,   ONEOF,    MESSAGE,  (cmd,io_get_state,cmd.io_get_state),   8) \
X(a, STATIC,   ONEOF,    MESSAGE,  (cmd,io_set_state,cmd.io_set_state),   9)
...
#define Command_cmd_io_get_state_MSGTYPE CommandIOGetState
#define Command_cmd_io_set_state_MSGTYPE CommandIOSetState
...
X(a, STATIC,   ONEOF,    MESSAGE,  (type,io_get_state,type.io_get_state),   7)
...
#define Response_type_io_get_state_MSGTYPE ResponseIOGetState

#define CommandIOSetState_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    pin,               1) \
X(a, STATIC,   SINGULAR, UENUM,    state,             2)
#define CommandIOSetState_CALLBACK NULL
#define CommandIOSetState_DEFAULT NULL

#define CommandIOGetState_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    pin,               1)
#define CommandIOGetState_CALLBACK NULL
#define CommandIOGetState_DEFAULT NULL

#define ResponseIOGetState_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    state,             1)
#define ResponseIOGetState_CALLBACK NULL
#define ResponseIOGetState_DEFAULT NULL
...
extern const pb_msgdesc_t CommandIOSetState_msg;
extern const pb_msgdesc_t CommandIOGetState_msg;
extern const pb_msgdesc_t ResponseIOGetState_msg;
...
#define CommandIOSetState_fields &CommandIOSetState_msg
#define CommandIOGetState_fields &CommandIOGetState_msg
#define ResponseIOGetState_fields &ResponseIOGetState_msg
...
#define CommandIOGetState_size                   2
#define CommandIOSetState_size                   4
...
#define ResponseIOGetState_size                  2
